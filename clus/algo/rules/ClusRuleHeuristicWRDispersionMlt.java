...
public class ClusRuleHeuristicWRDispersionMlt extends ClusRuleHeuristicDispersion {
	
	public ClusRuleHeuristicWRDispersionMlt(ClusAttributeWeights prod) {
	}

	public ClusRuleHeuristicWRDispersionMlt(ClusStatManager stat_mgr, ClusAttributeWeights prod) {
  ...
  // We only need the second parameter for rules!
	public double calcHeuristic(ClusStatistic c_tstat, ClusStatistic c_pstat, ClusStatistic missing) {
		...
		double pos_comp = ((CombStat)c_pstat).wRDispersionMltHeur();
		// Rule distance part
	...
	public String getName() {
		return "Rule Heuristic (Reduced Weighted Relative Dispersion, Multiplicative ver.)";
	}
